...
void handleDHT(){
  ...
  // Serial.print(F("°C "));
  char buffer[50];
  sprintf(buffer, "{\"heat\":%5.2f,\"temp\":%5.2f,\"hic\":%5.2f}",humid,temp,hic);
